...
?>
    ...
    <script>
        ...
        function add_client_type() {
            ...
            var id = get_value_by_name("client_select");
            var user_id = id.substr(0, id.indexOf(")"));
...
print table_content( "SELECT rate, dry_rate AS מרווח, type AS 'שם מחירון' FROM im_client_types" );