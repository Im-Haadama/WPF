...
//	var_dump($client);
		...
		$new_tran  = Core_Html::gui_table_args( array(
			...
			array("class"=>"widefat"));
		else $new_tran = Core_Html::GuiHeader(1, "לא ניתן להחבר ל Invoice4u. בדוק את ההגדרות ואת המנוי. יוזר $invoice_user");
	...
	static function create_receipt( $cash, $bank, $check, $credit, $change, $user_id, $date, $row_ids )
	{
