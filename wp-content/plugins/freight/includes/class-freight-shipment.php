...
class Freight_Shipment {
	...
	static function AddMethod($path_id, $zone_id, $week_day, $hours)
	{
		$db_prefix = get_table_prefix();
		...
		sql_query("insert into ${db_prefix}path_shipments (path_id, zone, week_day, hours) values ($path_id, $zone_id, $week_day, $hours)");
