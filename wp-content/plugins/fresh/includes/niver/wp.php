...
//require_once( FRESH_INCLUDES . "/wp-includes/load.php" );
//require_once( FRESH_INCLUDES . "/wp-includes/pluggable.php" );
//require_once( FRESH_INCLUDES . "/wp-includes/taxonomy.php" );
require_once( FRESH_INCLUDES . '/niver/data/translate.php' );
