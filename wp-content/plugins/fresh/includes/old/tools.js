...
function update_address(f, client_id, order_id) {
    ...
    var request = "/fresh/orders/orders-post.php?operation=update_address&f=" + f + "&address=" + encodeURI(address) +
        "&client_id=" + client_id +
        "&order_id=" + order_id;
...
function update_preference(client_id) {
    ...
    var request = "/fresh/orders/orders-post.php?operation=update_preference&preference=" + encodeURI(preference) +
        "&client_id=" + client_id;
