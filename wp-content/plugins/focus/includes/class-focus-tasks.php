...
//		print $operation;
	...
	static function Args()
	{
		...
		if (GetParam("non_active", false, false)) $args["non_active"] = 1;
	...
	{
		if (GetArg($args, "non_active", false)) return " 1 ";
...
//			}
	...
	static function main( $user_id, $args = null ) {
		...
		if ($mine) array_push($tabs, array("my_work", "My work", $mine));

		// tasks I initiated.
		$i_want = self::i_want($args, $user_id);
		if ($i_want) array_push($tabs, array("i_want", "I want", $i_want));
