...
//		$args["selectors"] = array( "team_members" => __CLASS__ . "::gui_show_team" );
	 ...
	 * @throws Exception
	 */
	static function show_templates( &$not_sure_about_this_args, $template_id = 0 ) {
		$url = GetUrl( 1 );
...
//		);
		...
		if ( $template_id ) {
			...
			$tasks_args = self::Args("im_tasklist");
