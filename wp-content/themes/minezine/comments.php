...
<div id="comments" class="comments-area<?php if ( get_theme_mod('minezine_next_preview_post', minezine_default_options('minezine_next_preview_post')) == 'Display' || get_theme_mod('minezine_next_preview_post', minezine_default_options('minezine_next_preview_post')) == '' ) { ?> comments-area-post<?php } ?>">
