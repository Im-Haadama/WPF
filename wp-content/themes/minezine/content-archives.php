...
<?php if ( get_theme_mod('minezine_display_meta_post', minezine_default_options('minezine_display_meta_post')) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php if ( get_theme_mod('minezine_content_archives', minezine_default_options('minezine_content_archives')) != 'Content' ) { ?>
<?php the_excerpt(); ?>
<?php } else { ?>
...
<?php if ( get_theme_mod('minezine_display_meta_post', minezine_default_options('minezine_display_meta_post')) != 'Hide' && has_category() ) { ?>
        <div class="post-info">
